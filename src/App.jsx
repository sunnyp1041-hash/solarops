      ...
      <div style={{ width:"100%", maxWidth:420 }}>
        ...
        <div className="card" style={{ padding:32 }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
            ...
            {mode==="login" && (
              <button onClick={handleForgotPassword} style={{ background:"none", border:"none", color:"var(--text3)", fontSize:12, cursor:"pointer", textAlign:"center", padding:"4px 0" }}>
            ...
            <button onClick={handleGoogle} style={{ background:"#fff", color:"#000", fontWeight:600, fontSize:14, padding:"12px 0", borderRadius:10, border:"none", cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center", gap:10, transition:"all .2s" }}
